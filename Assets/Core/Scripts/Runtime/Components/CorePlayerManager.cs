...
namespace Blocks.Gameplay.Core
{
    ...
    public class CorePlayerManager : NetworkBehaviour
    {
        ...
        [Tooltip("If true, sprint input increases movement speed and consumes stamina. Disable this when the sprint input channel is reused by another ability.")]
        ...
        private void UnregisterEventListeners()
        {
            ...
            if (enableSprinting && onSprintStateChanged != null)
