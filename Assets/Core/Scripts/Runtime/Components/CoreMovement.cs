...
namespace Blocks.Gameplay.Core
{
    ...
    public class CoreMovement : NetworkTransform
    {
        ...
        /// <summary>
        /// Optional resolver for the final walk/sprint speed. Gameplay modules can compose derived
        /// attributes without making CoreMovement depend on a project-specific stat system.
        /// </summary>
        public Func<float, float> MoveSpeedResolver { get; set; }
