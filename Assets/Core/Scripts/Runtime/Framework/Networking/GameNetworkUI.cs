...
namespace Blocks.Gameplay.Core
{
    ...
    public class GameNetworkUI : MonoBehaviour
    {
        ...
        private VisualElement m_NetworkMainContainer;
        ...
        {
            m_Root = m_UIDocument.rootVisualElement;
            m_NetworkMainContainer = m_Root.Q<VisualElement>("network-main-container");
        ...
        private void UpdateUI()
        {
            ...
            // The connection menu is only an entry surface. Once the local peer is
            // connected, hide the entire container so it cannot cover gameplay or
            // continue intercepting pointer input. It is shown again automatically
            // after a disconnect or failed connection.
            bool isConnected = state.ConnectionState == GameNetworkManager.ConnectionStates.Connected;
            if (m_NetworkMainContainer != null)
            {
                m_NetworkMainContainer.style.display = isConnected ? DisplayStyle.None : DisplayStyle.Flex;
            }
