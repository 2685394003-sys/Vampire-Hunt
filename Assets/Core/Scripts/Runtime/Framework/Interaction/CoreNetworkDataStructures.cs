...
namespace Blocks.Gameplay.Core
{
    ...
    public struct RuntimeStat : INetworkSerializable, IEquatable<RuntimeStat>
    {
        ...
        /// <summary>
        /// The authoritative runtime capacity. Unlike the immutable definition value, this can be
        /// changed by server-owned gameplay effects and is replicated for HUD and late joiners.
        /// </summary>
        ...
        public bool Equals(RuntimeStat other)
        {
            return StatHash == other.StatHash &&
                   ...
                   Mathf.Approximately(MaxValue, other.MaxValue) &&
